...
test("CityList render", async () => {
    const { findAllByRole } = render(<CityList cities={cities} onClickCity={() => {}} allWeather={{}} onSetAllWeather={() => {}}/>)
...
test("CityList click on item", async () => {
    ...
    const { findAllByRole } = render(<CityList cities={cities} onClickCity={fnClickOnItem} allWeather={{}} onSetAllWeather={() => {}}/>)
